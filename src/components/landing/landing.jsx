      ...
      <div className={stylesCSS.pageContainer}>
        <div className={`${stylesCSS.headBanner} ${stylesCSS.centerCard}`}>
          ...
          <div className={stylesCSS.taglineContainer}>
            <p>Community Medicine Department GMCS</p>
          </div>
        ...
        <div
          className={`${stylesCSS.featureContainer} ${stylesCSS.centerCard} ${stylesCSS.whiteBackground}`}
        >
        ...
        <div
          className={`${stylesCSS.featureContainer} ${stylesCSS.centerCard}`}
        >
          <div className={stylesCSS.featureImage}>
          ...
          <div className={stylesCSS.featureInfo}>
            <p>
              ...
              result. <br />
              You also get detailed result of the whole class and on a per
              student basis
            </p>
          </div>
        </div>
        <div
          className={`${stylesCSS.centerCard}  ${stylesCSS.whiteBackground}`}
        >
        ...
        {/* <div className={stylesCSS.contactDetails}>
          <div className={stylesCSS.developer}>
            <p>
              ...
              <a
                href="https://www.linkedin.com/in/abhpd/"
                target="_blank"
              ...
              Anubhav Sharma |{" "}
              <a
                href="https://www.linkedin.com/in/anubhav-sharma-0356641b6/"
                target="_blank"
                rel="noopener noreferrer"
              >
                Linkedin
              ...
              |{" "}
              <a
                href="https://github.com/19BCS1114"
                target="_blank"
                rel="noopener noreferrer"
              >
                Github
